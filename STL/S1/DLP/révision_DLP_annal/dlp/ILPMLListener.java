...
import antlr4.ILPMLgrammar4exam1920Listener;
import antlr4.ILPMLgrammar4exam1920Parser.IterableContext;

import static antlr4.ILPMLgrammar4exam1920Parser.*;

public class ILPMLListener implements ILPMLgrammar4exam1920Listener {
	...
	@Override
	public void enterIterable(IterableContext ctx) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void exitIterable(IterableContext ctx) {
		// TODO Auto-generated method stub
		//		ctx.node = factory.newLoop(ctx.condition.node, ctx.body.node);		

		ctx.node = factory.newIterable(ctx.val.node,factory.newVariable(ctx.getText()),ctx.body.node);
	}
