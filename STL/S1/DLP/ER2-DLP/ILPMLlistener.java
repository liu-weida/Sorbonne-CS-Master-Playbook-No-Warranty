...
import antlr4.ILPMLgrammarExamListener;
import antlr4.ILPMLgrammarExamParser.AlternativeContext;
import antlr4.ILPMLgrammarExamParser.BinaryContext;
import antlr4.ILPMLgrammarExamParser.BindingContext;
import antlr4.ILPMLgrammarExamParser.ClassDefContext;
import antlr4.ILPMLgrammarExamParser.ClassDefinitionContext;
import antlr4.ILPMLgrammarExamParser.CodefinitionsContext;
import antlr4.ILPMLgrammarExamParser.ConstFalseContext;
import antlr4.ILPMLgrammarExamParser.ConstFloatContext;
import antlr4.ILPMLgrammarExamParser.ConstIntegerContext;
import antlr4.ILPMLgrammarExamParser.ConstStringContext;
import antlr4.ILPMLgrammarExamParser.ConstTrueContext;
import antlr4.ILPMLgrammarExamParser.ExprContext;
import antlr4.ILPMLgrammarExamParser.FilterContext;
import antlr4.ILPMLgrammarExamParser.GlobalDefContext;
import antlr4.ILPMLgrammarExamParser.GlobalFunDefContext;
import antlr4.ILPMLgrammarExamParser.GlobalFunctionDefinitionContext;
import antlr4.ILPMLgrammarExamParser.InvocationContext;
import antlr4.ILPMLgrammarExamParser.LambdaContext;
import antlr4.ILPMLgrammarExamParser.LocalFunDefContext;
import antlr4.ILPMLgrammarExamParser.LoopContext;
import antlr4.ILPMLgrammarExamParser.MethodDefContext;
import antlr4.ILPMLgrammarExamParser.NewContext;
import antlr4.ILPMLgrammarExamParser.ProgContext;
import antlr4.ILPMLgrammarExamParser.ReadFieldContext;
import antlr4.ILPMLgrammarExamParser.SelfContext;
import antlr4.ILPMLgrammarExamParser.SendContext;
import antlr4.ILPMLgrammarExamParser.SequenceContext;
import antlr4.ILPMLgrammarExamParser.SumContext;
import antlr4.ILPMLgrammarExamParser.SuperContext;
import antlr4.ILPMLgrammarExamParser.TryContext;
import antlr4.ILPMLgrammarExamParser.UnaryContext;
import antlr4.ILPMLgrammarExamParser.VariableAssignContext;
import antlr4.ILPMLgrammarExamParser.VariableContext;
import antlr4.ILPMLgrammarExamParser.WriteFieldContext;

public class ILPMLlistener implements ILPMLgrammarExamListener {

	private IASTfactory factory;
	
	public ILPMLlistener(IASTfactory f) {
		super();
		this.factory = f;
	}
	...
	public void exitSum(SumContext ctx) {
		ctx.node = factory.newSum(ctx.discrim.getText(), toExpressions(ctx.args));
	}
	...
	public void exitFilter(FilterContext ctx) {
		...
		IASTvariable[] vars = toVariables(ctx.vars, false);
		ctx.node = factory.newFilter(ctx.sum.node, tag, vars, ctx.consequence.node, ctx.alternant.node);
	}
